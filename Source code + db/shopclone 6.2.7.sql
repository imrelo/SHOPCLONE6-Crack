...
('root', '[{\"db\":\"shop\",\"table\":\"users\"},{\"db\":\"shop\",\"table\":\"banks\"},{\"db\":\"shop\",\"table\":\"accounts\"}]');
...
('root', '2023-09-08 05:41:42', '{\"Console\\/Mode\":\"collapse\"}');
...
(3, 'Đồng', 'VND', 1, '', 'đ', 'dot', 1, 0, 0),
(4, 'Dollar', 'USD', 23558, '$', '', 'dot', 1, 1, 2);
...
(5, 661, '70.36.119.102', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36', '2023-09-06 16:31:28', '[Warning] Đăng nhập thành công vào hệ thống Admin'),
(6, 661, '70.36.119.102', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36', '2023-09-06 16:51:29', 'Set mặc định tiền tệ (Dollar ID 4)'),
(7, 661, '70.36.119.102', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36', '2023-09-06 16:53:01', 'Xoá chuyên mục tài liệu (TUT Tiki ID 3)'),
(8, 661, '70.36.119.102', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36', '2023-09-06 16:53:01', 'Xoá chuyên mục tài liệu (TUT Facebook ID 1)'),
(9, 661, '70.36.119.102', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36', '2023-09-06 16:55:52', 'Xoá chuyên mục (XEM THÊM ID 15)'),
(10, 661, '116.96.46.140', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36', '2023-09-08 00:53:15', '[Warning] Đăng nhập thành công vào hệ thống Admin');
...
--
-- Dumping data for table `nowpayments`
--
...
--
-- Dumping data for table `payment_flutterwave`
--

INSERT INTO `payment_flutterwave` (`id`, `user_id`, `tx_ref`, `amount`, `currency`, `create_gettime`, `update_gettime`, `status`) VALUES
(1, 661, '5c5276a7b3d2afcef6bf845e328928c1', 0, 'NGN', '2023-09-06 16:55:05', '2023-09-06 16:55:05', 'pending');
...
(661, 'admin', '$2a$10$F81A1hu0DC4RCnRvQs2NK.lVDKEt5nu5nmsusYw3lXGHFi8DIPllm', 'admin@cmsnt.co', NULL, NULL, 1, 0, 0, 0, 0, '2022-07-20 21:50:20', '2022-07-20 21:50:20', 1694109336, 1694109195, '116.96.46.140', '7293af2a093425a0e8c24ddd469ffa96', 704211, 1208030, 0, NULL, 'Male', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36', NULL, 0, 'IDSSEL7SXQ5XUA54', 0, 0, 0, 2, 0, 0, 0, 0, 0, NULL, 0);
